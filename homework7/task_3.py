...
class Cell:
    ...
    def __sub__(self, other):
        if self.num_cells - other.num_cells > 0:
            ...
            print("Error! The difference in the number of cells <= 0")
    ...
    def make_order(self, cells_per_row):
        rows = self.num_cells // cells_per_row
        remainder = self.num_cells % cells_per_row
        return '/n'.join(['*' * cells_per_row] * rows + ['*' * remainder])
